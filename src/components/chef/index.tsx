                    ...
                    tickets.map((ticket,idx) => {
                        return(<div key={idx} className="flex flex-col w-full mt-2 p-1 border border-black border-solid">
                            ...
                            <div className="grow flex flex-col w-full mt-2 ">
                                <div className="min-h-10 flex flex-wrap pb-5 justify-center items-center">
                                {
                                ...
                                <button className="border-black border-solid border h-8 w-full hover:bg-neutral-100" onClick={()=>order(ticket.pic.id)}>cook</button>
                            </div>
                        </div>);
                    })
                }
